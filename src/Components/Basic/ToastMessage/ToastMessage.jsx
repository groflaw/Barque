...
const ToastMessage = forwardRef(({ type, description, timeout = 5000 }, ref) => {
    ...
    return (
        <>
            {isVisible && <Animated.View style={{
                ...
                marginLeft : '3%',
                marginRight : '3%',
                width: '94%', height: 50, backgroundColor: backgroundColor, borderRadius: 10,
                paddingTop: 5,
                paddingBottom : 5,
                paddingLeft :15,
                paddingRight : 15,
            ...
            >
                ...
                <View style={{ marginLeft: 12 }} className = "text-center">
